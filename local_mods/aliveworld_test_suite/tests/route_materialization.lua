...
T.register_test("aliveworld", "route_materialization_safe_edits_and_blocks_hazards", function(ctx)
	...
	ctx.assert.is_true((report.cleared_nodes or 0) >= 1, "vegetation should be counted as clearable")
	...
	ctx.assert.is_true((report.skipped_blocked or 0) >= 1, "metadata or unknown solid must be skipped")
